...
L["Rename"] = "Rename"
L["Copy"] = "Copy"
L["A profile named \"%s\" already exists."] = "A profile named \"%s\" already exists."
L["Existing profile: Save overwrites; rename/copy need a new name."] = "Existing profile: Save overwrites; rename/copy need a new name."
L["Profile renamed: %s"] = "Profile renamed: %s"
L["Profile copied: %s"] = "Profile copied: %s"
L["Load"] = "Load"
L["Delete"] = "Delete"
L["Profile name is required."] = "Profile name is required."
L["Profile names may not be longer than 32 characters."] = "Profile names may not be longer than 32 characters."
L["Profile saved: %s"] = "Profile saved: %s"
L["Profile loaded: %s"] = "Profile loaded: %s"
L["Profile deleted: %s"] = "Profile deleted: %s"
L["Select a profile first."] = "Select a profile first."
L["Overwrite"] = "Overwrite"
L["Cancel"] = "Cancel"
L["Overwrite profile \"%s\"?"] = "Overwrite profile \"%s\"?"
